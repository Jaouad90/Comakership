...
namespace Comakerships_Api.Filters
{
    /// <summary>
    ...
    public class FileUploadOperation : IOperationFilter
    {
        ...
        public void Apply(OpenApiOperation operation, OperationFilterContext context)
        {
            ...
            // uncomment if you want to completely clear the parameters. In the case of the Deliverable upload we'd still need the path param {id}
