...
{   /// <summary>
    ...
    public class Company : IEntityBase
    {
        ...
        /// <summary>
        /// Contains the list of ID's of published comakerships by the company.
        /// </summary>
        /// <example>1,2</example>
        [JsonRequired(RequirementPolicy.Never)]
        public ICollection<Comakership> Comakerships { get; set; }
        ...
        /// <summary>
        /// Contains the reviews given to the company by students who previously participated in a comakership from the company.
        /// </summary>
