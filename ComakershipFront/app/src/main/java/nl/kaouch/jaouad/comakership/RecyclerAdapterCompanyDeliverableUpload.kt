...
class RecyclerAdapterCompanyDeliverableUpload(
    private val context: Context,
    private val deliverables: List<Deliverable>?,
    private val listener: onDeliverableClickListener
): RecyclerView.Adapter<RecyclerAdapterCompanyDeliverableUpload.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerAdapterCompanyDeliverableUpload.ViewHolder {
    ...
    override fun onBindViewHolder(
        holder: RecyclerAdapterCompanyDeliverableUpload.ViewHolder,
        position: Int
    ) {
        ...
        if (!deliverables!!.isNullOrEmpty()) {
            ...
            holder.title.text = "No existing deliverable found!!"
        }
    }
    ...
    inner class ViewHolder(articleView: View): RecyclerView.ViewHolder(articleView), View.OnClickListener {
        ...
        var statusDropdown: Spinner = itemView.findViewById(R.id.deliverable_status_dropdown)
